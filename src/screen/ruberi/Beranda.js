...
const Beranda = ({navigation}) => {
  ...
  {/* <Header title='Ruberi'/> */}
  <ImageBackground source={require('../assets/backgrd.png')} resizeMode="cover" style={styles.image}>
 
 </ImageBackground>

  
  <View style={styles.beri}>
  <TouchableOpacity style={styles.klik} onPress={()=>navigation.navigate('Register')}>
    <View style={styles.lapisan}>
      <Text style={{color:'black',width:80,height:30,marginLeft:40,marginTop:10}}>Register</Text>
    </View>
  </TouchableOpacity>
  <TouchableOpacity style={styles.klik2} onPress={() => navigation.navigate('Login')}>
  <View>
